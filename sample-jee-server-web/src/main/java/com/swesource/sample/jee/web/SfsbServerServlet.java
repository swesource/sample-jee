 ...
 *
 */
@WebServlet(value = "/SfsbServerServlet")
public class SfsbServerServlet extends HttpServlet {

    private static final Logger LOGGER = Logger.getLogger(SfsbServerServlet.class.getName());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        pw.write("SfsbServerServlet -> ServerSfsbBean.sayHello (in same EAR) -> [" + greeting + "]");
        pw.flush();
        pw.close();
    }
    ...
    private String invokeServerBean() throws NamingException {
        ...
        LOGGER.info("SfsbServerServlet: Received greeting: " + greeting);
        return greeting;
    }
}
